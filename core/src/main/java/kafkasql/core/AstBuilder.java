...
import kafkasql.core.parse.SqlStreamParserBaseVisitor;
import kafkasql.core.parse.SqlStreamParser.ReadStmtContext;
...
public class AstBuilder extends SqlStreamParserBaseVisitor<AstNode> {
  ...
  public ProjectionExpr visitReadProjectionExpr(SqlStreamParser.ReadProjectionExprContext c) {
    ...
    if (c.fieldAlias() != null) {
      Identifier a = visitFieldAlias(c.fieldAlias());
  ...
  @Override
  public Identifier visitFieldAlias(SqlStreamParser.FieldAliasContext c) {
    return visitIdentifier(c.identifier());
  }

...
import { KafkaSqlProjectExplorer } from './kafkaSqlProjectExplorer';
...
export function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('kafkasql.selectForCompare', (uri: vscode.Uri) => {
      compareBaseUri = uri;
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('kafkasql.compareWithSelected', (uri: vscode.Uri) => {
      if (!compareBaseUri) {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('kafkasql.compareWithActive', async (uri?: vscode.Uri) => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('kafkasql.changeComparisonMode', () => pickComparisonMode())
  );
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('kafkasql.explorer.refresh', () => explorer.refresh()),
    vscode.commands.registerCommand('kafkasql.explorer.toggleFlatContexts', () => explorer.toggleFlatContexts()),
    vscode.commands.registerCommand('kafkasql.explorer.expandAll', async () => {
